...
declare global {
  var __PIXELS_SCENE_BROWSER_STORE__: SceneBrowserStoreApi | undefined
}

const hotStore = import.meta.env.DEV ? globalThis.__PIXELS_SCENE_BROWSER_STORE__ : undefined
...
if (import.meta.env.DEV) {
  globalThis.__PIXELS_SCENE_BROWSER_STORE__ = sceneBrowserStore
}
